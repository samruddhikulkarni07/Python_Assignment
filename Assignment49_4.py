...
# Description: This Function Evaluates the model
# Parameters: 
#             Y_test -> testingoutput
#             Y_pred1 -> predicted output from model1
#             Y_pred2 -> predicted output from model2
...
def ModelEvaluation(Y_pred1,Y_pred2,Y_test,message):

    DisplayInfo(message)

    print("Accuracy_score of DecisionTree is: ",accuracy_score(Y_pred1,Y_test))
    print("Accuracy_score of LogisticRegression is: ",accuracy_score(Y_pred2,Y_test))

    cm1 = confusion_matrix(Y_pred1,Y_test)
    print("Confusion matrix of DecisionTree is:",cm1)
    cmd1 = ConfusionMatrixDisplay(confusion_matrix=cm1,display_labels=['Yes','No'])
    cmd1.plot(cmap='Blues')
    plt.show()

    cm2 = confusion_matrix(Y_pred2,Y_test)
    print("Confusion matrix of LogisticRegression is:",cm2)
...
def ModelPrediction(X_test_scaled,Y_test,model1,model2,message):
    ...
    ModelEvaluation(Y_pred1,Y_pred2,Y_test,"Model Evaluation")
