...
def Sent_mail(sender,app_password,receiver,subject,body):
    global log_file_path
...
def main():
    ...
    #python Demo.py 5 Marvellous
        ...
        subject = "Platform surveillence system"

        body = "Check attached file"

        schedule.every(1).minute.do(Sent_mail,sender_email,app_password,receiver_email,subject,body)
