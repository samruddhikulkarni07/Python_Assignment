...
#when Random State = 0, Accuracy of model: 83.33333333333334
#when Random State = 10, Accuracy of model: 83.33333333333334
#when Random State = 42, Accuracy of model: 100.0

#yes the result will changes